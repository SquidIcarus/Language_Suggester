window.onload = function () {
    ...
    form.onsubmit = function (event) {
        ...
        if (parseInt(numbChoice) <= 13 && question4.toLowerCase() !== "black") {
            response += "You like spooky numbers! ";
        } else if (parseInt(numbChoice) >= 22 && parseInt(numbChoice) <= 99 && question4.toLowerCase() !== "black") {
            response += "Keeping it simple i see ";
        } else if (parseInt(numbChoice) >= 100 && question4.toLowerCase() !== "black") {
